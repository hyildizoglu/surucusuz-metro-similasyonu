...
class MetroAgi:
    ...
    def en_az_aktarma_bul(self, baslangic_id: str, hedef_id: str) -> Optional[List[Istasyon]]:
        # Başlangıç ve hedef istasyonların kontrolü
        ...
        # Kuyruk yapısı: (şu anki istasyon, izlenen yol)
        ...
        while kuyruk:
            ...
            ziyaret_edildi.add(suanki.idx)

            # Komşuları sıraya ekle
            for komsu, _ in suanki.komsular:
    ...
    def en_hizli_rota_bul(self, baslangic_id: str, hedef_id: str) -> Optional[Tuple[List[Istasyon], int]]:
        ...
        # Öncelik kuyruğu: (toplam süre, id, şu anki istasyon, izlenen yol)
        ...
        while pq:
            ...
            if suanki.idx in ziyaret_edildi:
                continue

            ziyaret_edildi.add(suanki.idx)

            # Komşuları öncelik kuyruğuna ekle (toplam süreye göre sıralanır)
